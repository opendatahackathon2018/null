...
function Marker(poiData) {
    ...
    */
    ...
    this.titleLabel = new AR.Label(poiData.title.trunc(13), 0.8, {
        zOrder: 1,
        translate: {
            y: 0.55
        },
    ...
    this.descriptionLabel = new AR.Label(poiData.description.trunc(20), 0.5, {
        zOrder: 1,
        translate: {
            y: -0.55
        },
...
Marker.prototype.setDeselected = function(marker) {
    ...
    marker.titleLabel.style.textColor = '#000000';
    marker.descriptionLabel.style.textColor = '#000000';
};
